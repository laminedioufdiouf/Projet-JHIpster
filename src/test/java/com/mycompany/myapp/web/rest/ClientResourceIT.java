...
public class ClientResourceIT {
    ...
    private static final Integer DEFAULT_NUMEROPIECE = 1;
    private static final Integer UPDATED_NUMEROPIECE = 2;
    ...
    public static Client createEntity(EntityManager em) {
        Client client = new Client()
            .numeropiece(DEFAULT_NUMEROPIECE)
    ...
    public static Client createUpdatedEntity(EntityManager em) {
        Client client = new Client()
            .numeropiece(UPDATED_NUMEROPIECE)
    ...
    public void createClient() throws Exception {
        ...
        assertThat(testClient.getNumeropiece()).isEqualTo(DEFAULT_NUMEROPIECE);
        assertThat(testClient.getNomcomplet()).isEqualTo(DEFAULT_NOMCOMPLET);
    ...
    public void getAllClients() throws Exception {
        ...
        restClientMockMvc.perform(get("/api/clients?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].numeropiece").value(hasItem(DEFAULT_NUMEROPIECE)))
    ...
    public void getClient() throws Exception {
        ...
        restClientMockMvc.perform(get("/api/clients/{id}", client.getId()))
            ...
            .andExpect(jsonPath("$.numeropiece").value(DEFAULT_NUMEROPIECE))
            .andExpect(jsonPath("$.nomcomplet").value(DEFAULT_NOMCOMPLET))
    ...
    public void updateClient() throws Exception {
        ...
        Client testClient = clientList.get(clientList.size() - 1);
        assertThat(testClient.getNumeropiece()).isEqualTo(UPDATED_NUMEROPIECE);
        assertThat(testClient.getNomcomplet()).isEqualTo(UPDATED_NOMCOMPLET);
